        ...
        <div className="grid md:grid-cols-3 gap-12 mb-16">
          <div className="flex flex-col gap-4">
            ...
            >
              <span className="flex items-center gap-2.5">
                <img src={logoUrl} alt="StoryGrid Media Logo" width={28} height={28} loading="lazy" className="h-7 w-auto" />
          ...
          <div className="flex flex-col gap-4 md:items-end">
            ...
            <div className="flex gap-4 mt-4">
              <a href="https://www.instagram.com/storygrid_media/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-[#FFC107] flex items-center justify-center text-black hover:bg-white transition-colors" data-testid="link-social-instagram" aria-label="Instagram">
                <span className="sr-only">Instagram</span>
                <Instagram size={20} />
              </a>
              <a href="https://www.youtube.com/channel/UC1XfuIuPuSGrUMYzHGsGZWg" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-[#FFC107] flex items-center justify-center text-black hover:bg-white transition-colors" data-testid="link-social-youtube" aria-label="YouTube">
